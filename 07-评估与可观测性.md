...
| 本文负责 | 本文不展开 |
|---|---|
| 评估与可观测的概念框架、三层评估、LLM-as-Judge、RAG/Agent 指标、数据飞轮 | 可运行的 eval dataset、runner、trace replay、CI gate、failure pool 和报告体系见 [24-Agent Eval Harness专题.md](./24-Agent%20Eval%20Harness专题.md) |
...
**深入理解**：提到**轨迹聚类**：把所有 trace 按工具序列聚类，分析高频路径 vs 异常路径。
